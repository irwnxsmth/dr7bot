...
const isOwner = [`${setting.ownerNumber}`,"6285171200031@s.whatsapp.net","6285171200031@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6285171200031@s.whatsapp.net'
...
mentions(`「 *TRANSAKSI SEDANG DIPROSES* 」\n\n\📆 TANGGAL : ${tanggal}\n⌚ JAM     : ${jam}\n✨ STATUS  : Sedang Diproses\n\n📝 Catatan : ${quotedMsg.chats}\n\nPesanan @${quotedMsg.sender.split("@")[0]} akan segera diproses`, [sender])
}
break
case 'd': case 'done':{
if (!isGroup) return ('Hanya Dapat Digunakan Gi Group')
